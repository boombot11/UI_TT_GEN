          ...
          <div className="relative z-10">
            <nav className="flex p-6 text-white">
                <ul className="flex justify-between w-[80vw] ">
                    <a href='/' className="cursor-pointer text-md font-semibold text-xl text-white/90">TimeTable Generator</a>
                    ...
                    <a href='/upload' className="cursor-pointer text-md border border-white/70 px-6 opacity-80 hover:bg-white hover:text-black duration-500 font-semibold rounded-md p-2"><a href="/upload">Upload file</a></a>
                </ul>
            </nav>
          </div>
        </div>
